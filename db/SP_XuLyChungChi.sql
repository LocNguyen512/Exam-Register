...
-- Thêm nhân viên
-- Xóa nhân viên
CREATE OR ALTER PROCEDURE SP_LAY_THONG_TIN_CHUNG_CHI
AS
BEGIN
    SELECT 
...
/*
CREATE OR ALTER PROCEDURE SP_LAY_CHUNGCHI_THEO_CCCD @cccd NVARCHAR(20)
AS
BEGIN
    SET NOCOUNT ON;
    ...
    END TRY
    BEGIN CATCH
        -- In case of an error, raise an error with a message
